...
def parse_args(default=False):
    ...
    parser.add_argument(
        ...
        type=str,
        default="/root/CodeGoat24/fastcomposer-main/model/models--runwayml--stable-diffusion-v1-5",
    ...
    parser.add_argument(
        "--dataset_name",
        type=str,
        default="/root/CodeGoat24/fastcomposer-main/data/ffhq_wild_files",
        help=(
    ...
    parser.add_argument("--finetuned_model_path", default="/root/CodeGoat24/fastcomposer-main/model/fastcomposer", type=str)
    ...
    parser.add_argument(
        ...
        type=str,
        default="/root/CodeGoat24/fastcomposer-main/model/models--openai--clip-vit-large-patch14",
    )
    ...
    parser.add_argument(
        "--test_caption",
        type=str,
        default="a man <|image|> and a man <|image|> are reading book together",
    ...
    parser.add_argument("--object_types", default="person", type=str)

    parser.add_argument("--object_localization", default=True, action="store_true")
    ...
    parser.add_argument(
        "--finetuned_model_text_only_path",
        type=str,
        default="/root/CodeGoat24/fastcomposer-main/model/fastcomposer_text_only",
    )
